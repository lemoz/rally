"""rally_013: storyboard-poster + single-Seedance-call architecture.
...
Usage:
    cd rally-poc && python3 render_rally_013_storyboard.py
"""
...
OUTPUT_DIR = Path("output/rally_013_storyboard")
...
VOICEOVER = (
    "10,000 devs are debugging the same problem alone. "
    "Then one video gets liked. "
...
def main() -> None:
    ...
    norm_path = NORM_DIR / "rally_013_seq.mp4"
